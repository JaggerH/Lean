...
namespace QuantConnect.Data
{
    ...
    public class Slice : ExtendedDictionary<Symbol, dynamic>, IEnumerable<KeyValuePair<Symbol, BaseData>>
    {
        ...
        /// <summary>
        /// Gets the <see cref="OrderbookDepths"/> for this slice of data
        /// </summary>
        public OrderbookDepths OrderbookDepths
        {
            get { return _orderbookDepths; }
        }
        ...
        public Slice(DateTime time, List<BaseData> data, DateTime utcTime)
            : this(time, data, CreateCollection<TradeBars, TradeBar>(time, data),
                ...
                CreateCollection<OrderbookDepths, OrderbookDepth>(time, data),
        ...
        protected Slice(Slice slice)
        {
            ...
            _orderbookDepths = slice._orderbookDepths;
        ...
        public Slice(DateTime time, List<BaseData> data, TradeBars tradeBars, QuoteBars quoteBars, Ticks ticks, OrderbookDepths orderbookDepths, OptionChains optionChains, FuturesChains futuresChains, Splits splits, Dividends dividends, Delistings delistings, SymbolChangedEvents symbolChanges, MarginInterestRates marginInterestRates, DateTime utcTime, bool? hasData = null)
        {
            ...
            _orderbookDepths = orderbookDepths;
        ...
        public void MergeSlice(Slice inputSlice)
        {
            ...
            _orderbookDepths = (OrderbookDepths)UpdateCollection(_orderbookDepths, inputSlice.OrderbookDepths);
