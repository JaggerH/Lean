...
{
    /// <summary>
    /// Provides Gate specific properties
    /// </summary>
    public class GateBrokerageModel : DefaultBrokerageModel
    {
        ...
        public GateBrokerageModel(AccountType accountType = AccountType.Margin)
            : base(accountType)
        {
        }

        /// <summary>
        /// Gate global leverage rule
        /// </summary>
        ...
        {
            var symbol = Symbol.Create("BTCUSDT", SecurityType.Crypto, Market.Gate);
            return SecurityBenchmark.CreateInstance(securities, symbol);
        }

        /// <summary>
        /// Provides Gate fee model
        /// </summary>
        /// <param name="security"></param>
        /// <returns></returns>
        public override IFeeModel GetFeeModel(Security security)
        {
            return new GateFeeModel();
        }

        /// <summary>
        /// Checks whether an order can be updated or not in the Gate brokerage model
        /// </summary>
