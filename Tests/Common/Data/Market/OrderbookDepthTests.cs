...
namespace QuantConnect.Tests.Common.Data.Market
{
    ...
    public class OrderbookDepthTests
    {
        ...
        public void ConstructorWithSymbolAndTimeSetsProperly()
        {
            ...
            var depth = new OrderbookDepth(symbol, time);
        ...
        public void ReadsValidCsvWith5Levels()
        {
            ...
            var depth = new OrderbookDepth();
            var result = depth.Reader(config, line, baseDate, false) as OrderbookDepth;
        ...
        public void ReadsValidCsvWithDecimalTimestamp()
        {
            ...
            Assert.IsNotNull(result);
            var expectedTime = baseDate.AddMilliseconds(18000677.3456);
        ...
        public void GetSourceHandlesBaseSecurityTypeAsDefault()
        {
            var depth = new OrderbookDepth();
            var date = new DateTime(2024, 1, 15);
            var symbol = Symbol.CreateBase(typeof(OrderbookDepth), Symbol.Create("BTCUSDT", SecurityType.Crypto, QuantConnect.Market.Binance), QuantConnect.Market.Binance);
        ...
        {
            var depth = new OrderbookDepth(Symbols.BTCUSD, new DateTime(2024, 1, 15));
        ...
        #region OrderbookDepths Collection Tests

        [Test]
        public void OrderbookDepthsCollectionCreation()
        {
            var collection = new OrderbookDepths();

            Assert.IsNotNull(collection);
        }

        [Test]
        public void OrderbookDepthsCollectionWithFrontier()
        {
            var frontier = new DateTime(2024, 1, 15);
            var collection = new OrderbookDepths(frontier);

            Assert.IsNotNull(collection);
        }

        [Test]
        public void OrderbookDepthsCollectionIndexer()
        {
            var collection = new OrderbookDepths();
            var depth = new OrderbookDepth(Symbols.BTCUSD, new DateTime(2024, 1, 15));
            depth.Bids.Add(new OrderbookLevel(100.00m, 10m));
