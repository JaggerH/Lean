"""
PEPE 期现价差分析 - Gate PEPEUSDT 现货 vs 期货

期现套利（Spot-Futures Arbitrage）分析：
- Leg1: Gate PEPEUSDT 现货
- Leg2: Gate PEPEUSDT 永续合约
...
class PEPESpreadAnalysis(BaseSpreadAnalysis):
    """PEPE 期现价差分析 - 现货 vs 永续合约"""
    ...
    def get_config(self):
        return {
            ...
            'output_path': Path(__file__).parent / 'PEPE_spot_futures_spread.png',
            'plot_title': 'PEPE Spot-Futures Spread Analysis (Gate)',
            'plot_figsize': (16, 9),
            'plot_dpi': 150,
        }
