...
class BinanceIntegrationTest(QCAlgorithm):
    """
    Binance Futures Integration Test Algorithm

    Tests basic Binance Futures brokerage functionality:
    ...
    def Initialize(self):
        ...
        # Add BTCUSDT on Binance Futures (USDT-margined perpetual futures)
        self.symbol = self.add_crypto_future("BTCUSDT", Resolution.TICK, Market.BINANCE).Symbol
